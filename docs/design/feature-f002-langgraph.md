...
Request: { "gate": str, "decision": bool }
...
def resume_gate(decision: bool) -> Command:
    return Command(resume={"gate_decision": decision})
```
...
- tech_stack 字段有 Pydantic 校验，initializer Node 入口校验技术栈一致性
